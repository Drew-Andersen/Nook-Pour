...
(
    'Margarita',
    'A classic tequila-based cocktail with citris flavor.',
...
(
    ...
    'Muddle mint with lime juice and simple syrup. Add run and top with club soda. Garnish with mint.',
    NULL
)
